	...
	public String process(Model model) {
		...
		if(cnt > 0){
			...
			if(shopCode==100) {
				...
				ArrayList<BoardEventDTO> dtos = dao.getArticles(daoMap);
			...
			if(shopCode!=100) {
				...
				ArrayList<BoardEventDTO> dtos = dao.getArticlesSub(daoMap);
				model.addAttribute("dtos", dtos);
				model.addAttribute("shopCode", shopCode);
			}
