...
<!-- Javascript files -->		
<!-- Custom JS -->
<!--<script type="text/javascript" charset="utf-8"  src="/js/custom.before.js"></script>-->
...
<!--slide-in-panel-!->
<script type="text/javascript" charset="utf-8" src="/js/plugins/slide-in-panel/modernizr.js"></script>
<script type="text/javascript" charset="utf-8" src="/js/plugins/slide-in-panel/main.js"></script>-->
<!--??????-->
<script src="/js/jasny-bootstrap.min.js"></script>
<!--??????-->
<!--<script type="text/javascript" charset="utf-8" src="/js/freewall.js"></script>-->  

<!-- CaroFredSel --!>
<script type="text/javascript" charset="utf-8" src="/js/jquery.carouFredSel-6.2.1-packed.js"></script>
<!-- include codemirror (codemirror.css, codemirror.js, xml.js, formatting.js) -->
<!--<script src="/1js/custom.after.js"></script>-->

<!--?̹?????? ????-!->

  <link href="//cdnjs.cloudflare.com/ajax/libs/codemirror/3.20.0/codemirror.min.css" rel="stylesheet" type="text/css">
  <link href="//cdnjs.cloudflare.com/ajax/libs/codemirror/3.20.0/theme/monokai.min.css" rel="stylesheet" type="text/css">
...
제 1 조 (목적) 
이 이용약관(이하 '약관')은 -헤르메스 인베스트먼트-(이하 헤르메스 인베스트먼트라 합니다)와 이용 고객(이하 '회원')간에 헤르메스 인베스트먼트가 제공하는 서비스의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다. 

제 2 조 (이용약관의 효력 및 변경) 
(1) 이 약관은 본 헤르메스 인베스트먼트에 가입된 고객을 포함하여 서비스를 이용하고자 하는 모든 이용자에 대하여 서비스 메뉴 및 헤르메스 인베스트먼트에 게시하여 공시하거나 기타의 방법으로 고객에게 공지함으로써 그 효력을 발생합니다. 약관의 게시는 -헤르메스 인베스트먼트-(www.hermesiv.com)사이트에서 확인 
할 수 있습니다. 
(2) 헤르메스 인베스트먼트는 합리적인 사유가 발생될 경우에는 이 약관을 변경할 수 있으며, 약관을 변경할 경우에는 지체 없이 이를 사전에 공시합니다. 
...
<script type="text/javascript">
    ...
    $(".tos-next").click(function(){
	alert($(".tos-thumbnails a:last-child").attr("href"));
        var im_page_no = $(".now_img").val();
        im_page_no++;
        $(".now_page").val(im_page_no);
        $.ajax({
