...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/uuplex/resources/main_script/mainCss/card.css" />
    <link rel="stylesheet" type="text/css" href="/uuplex/resources/main_script/mainCss/pattern.css" />
    <!--[if IE]>
...
<body class="demo-1">
                ...
                <div class="card">
                    <div class="card__container card__container--closed">
                        <svg class="card__image" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1920 500" preserveAspectRatio="xMidYMid slice">
                            ...
                            <image clip-path="url(#clipPath1)" width="1920" height="500" xlink:href="/uuplex/resources/main_images/movie21.png"></image>
                        </svg>
                    ...
                    <div class="card__container card__container--closed">
                        ...
                        <div class="card__content">
							...
							<div class="card__copy">
								...
								<button type="button" class="btn btn-default" onclick="window.location='/uuplex/event?shopCode=100'">이벤트 바로가기</button>
							</div>
						</div>
					</div>
                </div>
    ...
    <script src="/uuplex/resources/main_script/mainView/Card-circle.js"></script>
    <script src="/uuplex/resources/main_script/mainView/demo.js"></script>
</body>
