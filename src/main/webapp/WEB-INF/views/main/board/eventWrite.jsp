...
<h1 align="center">이벤트 작성</h1>

<div class="jb-cell">
<form action="eventWritePro" name="boardQnA" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return boardCheck()">
