...
<h1 align="center">이벤트 게시판 수정</h1>

<div class="jb-cell">
<form action="eventModifyPro" name="eventModifyView" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return eventModifyCheck()">
	...
	<div class="form-group">
    	...
    	<div class="col-sm-8">
     	  <input type="password" name="passwd" class="form-control" id="inputPassword" value="${dto.eventPasswd}" placeholder="비밀번호를 입력하세요" maxlength="16" style="font-family:'함초롱바탕'">
   	 	</div>
  	</div>
	
	<div class="form-group">
    	<label for="boardPassword" class="col-sm-2 control-label">이벤트 이미지</label>
    	<div class="col-sm-8">
    	  <input type="hidden" name="old_img" value="${dto.eventImg}">
     	  <input class="input" type="file" name="eventImg" accept="image/*">
   	 	</div>
  	</div>
