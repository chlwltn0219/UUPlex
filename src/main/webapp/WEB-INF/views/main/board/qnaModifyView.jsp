...
<div class="jb-cell">
<form action="qnAModifyPro" name="qnAModifyView" class="form-horizontal" method="post" onsubmit="return boardCheck()">
	...
	<div class="form-group">
    	...
    	<div class="col-sm-8">
     	  <input type="password" name="passwd" class="form-control" id="inputPassword" value="${dto.qnaPasswd}" maxlength="16" placeholder="비밀번호를 입력하세요" style="font-family:'함초롱바탕'">
   	 	</div>
  	</div>
