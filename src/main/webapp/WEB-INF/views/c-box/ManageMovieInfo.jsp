...
<body>
	...
	<button type="button" class="btn btn-primary btn-lg"
		data-toggle="modal" data-target="#addModal">add movie info</button>

	<!-- Button trigger  영화 리뷰 입력 모달 -->
	<button type="button" class="btn btn-primary btn-lg"
		data-toggle="modal" data-target="#reviewModal">add review</button>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="AddMovieInfo" method="post" name="addform"
						enctype="multipart/form-data">
						<table class="table">

							<tr>
								<th>Title1</th>
								<td colspan="4"><input type="text" name="title1"
									placeholder="영화제목(한글)" maxlength="50" required></td>
							</tr>
							<tr>
								<th>Title2</th>
								<td><input type="text" name="title2" placeholder="영화제목(원제)"
									maxlength="50"></td>
							</tr>
							<tr>
								<th>Director</th>
								<td colspan="4"><input type="text" name="director"
									placeholder="감독" maxlength="50" required></td>
							</tr>
							<tr>
								<th>Starring</th>
								<td colspan="4"><input type="text" name="starring"
									placeholder="주연배우" maxlength="50" required></td>
							</tr>
							<tr>
								<th rowspan="4">Genre</th>
								<td><input type="checkbox" name="genre" value="코미디">코미디</td>
								<td><input type="checkbox" name="genre" value="멜로">멜로
								</td>
								<td><input type="checkbox" name="genre" value="액션">액션
								</td>
								<td><input type="checkbox" name="genre" value="애니메이션">애니메이션</td>
							</tr>
							<tr>
								<td><input type="checkbox" name="genre" value="가족">가족</td>
								<td><input type="checkbox" name="genre" value="역사">역사
								</td>
							...
							<tr>
								...
								<td><input type="checkbox" name="genre" value="공포">공포
								</td>
								<td><input type="checkbox" name="genre" value="스릴러">스릴러
								</td>
							...
							<tr>
								...
								<td><input type="checkbox" name="genre" value="학원물">학원물
								</td>
							...
							<tr>
								...
								<td colspan="4"><input type="text" name="productionYear"
									placeholder=제작년도 maxlength="50">년</td>
							</tr>
							<tr>
								<th>RunTime</th>
								<td colspan="4"><input type="text" name="runTime"
									placeholder=러닝타임(분) maxlength="50">분</td>
							</tr>
							<tr>
								<th>ReleaseDate</th>
								<td colspan="4"><input type="date" name="releaseDate"
									placeholder=개봉일 maxlength="50" required></td>
							</tr>
							<tr>
								<th>Synopsis</th>
								<td colspan="4"><textarea name="synopsis"
										style="width: 100%">줄거리를 입력해주세요</textarea></td>
							</tr>
							<tr>
								<th>Poster</th>
							...
							<tr>
								<th>Trailer</th>
								<td colspan="4"><input type="text" name="trailer"
									placeholder="예고편링크" maxlength="50"></td>
							</tr>
							<tr>
								<th>Status</th>
								<td colspan="4"><input type="radio" name="status"
									value="비상영" checked>비상영 <input type="radio"
									name="status" value="상영중">상영중</td>
							</tr>
							<tr>
				...
				<div class="modal-body">
					...
					<form action="AddReview" method="post" name="reviewform"
						...
						<table class="table">
							<tr>
								<th>memId</th>
								<td class="star-input"><span class="input"> <input
										type="radio" name="star-input" value="1" id="p1"> <label
										for="p1">괜히봤어요</label> <input type="radio" name="star-input"
										value="2" id="p2"> <label for="p2">기대하진 말아요</label> <input
										type="radio" name="star-input" value="3" id="p3"> <label
										for="p3">무난했어요</label> <input type="radio" name="star-input"
