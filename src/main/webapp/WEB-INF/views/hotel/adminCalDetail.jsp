...
function cancelConfirm() {
    var a = confirm("예약번호 [" + document.adminCancel.reservNum.value + "]번 내역을 정말로 취소하시겠습니까?");
    
    if(a == true) {
		window.location='adminCancel?reservNum=${dto.reservNum}';
    } else {
    	window.location="adminCalendar";
    }
}
</script>
<div class="container">
<form action="adminCancel" method="post" name="adminCancel">
