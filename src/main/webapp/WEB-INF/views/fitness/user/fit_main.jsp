...
<!-- 				캐러셀 전체 설명 -->
	  ...
	  <!-- 3열 메뉴 -->
		<div class="row menu">
			<div class="col-sm-4">
				<img class="img-circle" src="${resources}/fitness/img/noun_645979_cc.png" alt="Generic placeholder image">
				<h2>프로그램 안내</h2>
			</div><!-- /.col-lg-4 -->
			<div class="col-sm-4">
				<img class="img-circle" src="${resources}/fitness/img/noun_667847_cc.png" alt="Generic placeholder image">
				<h2>수강 신청</h2>
			</div><!-- /.col-lg-4 -->
			<div class="col-sm-4">
				<img class="img-circle" src="${resources}/fitness/img/noun_99372_cc.png" alt="Generic placeholder image">
				<h2>환불</h2>
			</div><!-- /.col-lg-4 -->
		</div><!-- /.row -->
