...
CREATE TABLE m_movie_info (
   ...
   MPAARating VARCHAR2(30), /* °ü¶÷µî±Ş */
   productionYear NUMBER(4), /* Á¦ÀÛ³âµµ */
   runTime NUMBER(3), /* ·¯´×Å¸ÀÓ(ºĞ) */
...
CREATE TABLE m_movie_info (
   ...
   genre VARCHAR2(50), /* ì¥ë¥´ */
   MPAARating VARCHAR2(30), /* ê´€ëŒë“±ê¸‰ */
   productionYear NUMBER(4), /* ì œì‘ë…„ë„ */
   runTime NUMBER(3), /* ëŸ¬ë‹íƒ€ì„(ë¶„) */
   releaseDate DATE, /* ê°œë´‰ì¼ */
   poster VARCHAR2(100), /* í¬ìŠ¤í„° */
   movie_img1 VARCHAR2(100), /* ìŠ¤í‹¸ì»·1 */
   movie_img2 VARCHAR2(100), /* ìŠ¤í‹¸ì»·2 */
   trailer VARCHAR2(100), /* ì˜ˆê³ í¸ë§í¬ */
   status VARCHAR2(10), /* í˜„ì¬ìƒì˜ì—¬ë¶€ */
   synopsis VARCHAR2(4000), /* ì¤„ê±°ë¦¬ */
   country VARCHAR2(50) /* êµ­ê°€ */
);
...
<<<<<<< HEAD
COMMENT ON COLUMN m_movie_info.runTime IS '·¯´×Å¸ÀÓ(ºĞ)';
=======
